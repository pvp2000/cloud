...
public class AzureRestTemplate {
	 ...
	 * and password
	 */
	private static KeyStore createKeyStorePKCS12(String base64Certificate, String outstore)
			throws Exception {
	...
	public void restTemplate() {
		...
		SSLConnectionSocketFactory sslsf = new SSLConnectionSocketFactory(factory, verifier);
	 ...
	 */
	private static SSLSocketFactory getFactory(String base64Certificate, String outStore)
			throws Exception {
